...
def DrawGLScene2():
	...
	while phi <= (math.pi/2):
		...
		while theta <= (math.pi * 2):
			glTexCoord2f(0.0, 0.0); glVertex3fv(s(theta, phi))
			glTexCoord2f(0.5, 0.5); glVertex3fv(s(theta + aux, phi))				
			theta += aux
		glTexCoord2f(1.0, 1.0); glVertex3fv(s(phi, 0.0))
		glTexCoord2f(0.8, 0.8);glVertex3fv(s(phi+aux, 0.0))
		glEnd()
		phi += aux
